      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
            <div style={{ fontSize: 11, fontWeight: 400, letterSpacing: '0.22em', color: 'rgba(255,255,255,0.38)', textTransform: 'uppercase' }}>
              Career
            </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          <div style={{ fontSize: 13, fontWeight: 700, letterSpacing: '0.18em', color: '#3792E8', textTransform: 'uppercase', marginBottom: 24 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 28 }}>
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                <span style={{ fontSize: 10, fontWeight: 700, color: '#a0c9ff', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
                  One-time
                </span>
